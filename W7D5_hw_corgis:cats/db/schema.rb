...
ActiveRecord::Schema[7.0].define(version: 2023_02_24_050045) do
  ...
  create_table "toys", force: :cascade do |t|
    ...
    t.index ["toyable_type", "toyable_id", "name"], name: "index_toys_on_toyable_type_and_toyable_id_and_name", unique: true
